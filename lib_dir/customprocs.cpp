...
/**
 * Longueur d'une chaine ASCIIZ.
 *
 * @param str	Chaine ASCIIZ
...
/**
 * Reimplementation d'un `itoa'.
 *
 * @param buf16		Buffer de 16 Bit fournir
 * @param val		Valeur NON signe a convertir
 * @param base		Base de conversion (2 a 16)
 * @return			Adresse de la chaine obtenue
 */
 ...
 *
 * @param ms	Nombre de millisecondes a attendre.
 */
