...
/**
 * Remet a 0 les broches occupees par l'afficheur LCD sur un port.
 *
...
/**
 * Active, attend et desactive la ligne EN.
 *
 * @param port	Port AVR occupe par l'afficheur
 */
static void _lcm_fast_en(volatile uint8_t* port) {
	*port |= _BV(LCM_EN);
	_delay_loop_1(4); // Laisser le temps a l'afficheur de comprendre EN
	*port &= ~_BV(LCM_EN);
}

/**
 * Envoie une fonction a l'afficheur LCD.
 *
 * @param rs		Valeur de la ligne RS
 * @param rw		Valeur de la ligne R/W
 * @param db		Valeur du `data bus' (DB7-DB0)
 * @param w_10us	Nombre de (10 us) a attendre apres l'envoi
 * @param port		Port AVR occupe par l'afficheur
 */
...
/**
 * Pilote - efface l'affichage en cours avec le caractere 0x20.
 *
 * @param port		Port AVR occupe par l'afficheur
 */
 ...
 *
 * @param id		Incrementation ou decrementation des adresses
 * @param s		Activation du decalage d'affichage
 * @param port		Port AVR occupe par l'afficheur
 */
...
/**
 * Pilote - ajuste certains parametres d'affichage.
 *
 ...
 *
 * @param sc		Decaler l'affichage ou deplacer le curseur
...
/**
 * Pilote - fixe certains parametres de l'afficheur LCD.
 *
 ...
 *
 * @param addr		Adresse de la CG RAM (0x00 a 0x3f)
 * @param port		Port AVR occupe par l'afficheur
 */
 ...
 *
 * @param addr		Adresse de la DD RAM (0x00 a 0x27 et 0x40 a 0x67)
 * @param port		Port AVR occupe par l'afficheur
 */
...
/**
 * Pilote - ecrit un octet a l'adresse en cours de la CG RAM ou de la DD RAM.
 *
 ...
 *
 * @param ddr		`Data Direction Register' AVR occupe par l'afficheur
 * @param port		Port AVR occupe par l'afficheur
 */
